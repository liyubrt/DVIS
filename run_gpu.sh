...
# # Finetune MinVIS segmenter on COCO + YTVIS 2022 + Jupiter humans 6k
...
# # convert Wan2.2 generated videos to ytvis format
# python prepare_videos_for_inference.py \
#     --input-dir /home/li.yu/code/mymnt/Wan2.2/sample_videos_gemini \
#     --output-dir /home/li.yu/code/mymnt/DVIS/datasets/sample_videos_gemini \
