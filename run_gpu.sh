...
#SBATCH --output=/home/li.yu/code/scripts/ytvis2022_rfdetr_sl_ft_0504.txt
...
# # Finetune MinVIS segmenter on YTVIS 2022
# cd /home/li.yu/code/mymnt/DVIS
# python train_net_video.py \
#   --num-gpus 4 \
#   --config-file /home/li.yu/code/mymnt/DVIS/configs/youtubevis_2022/swin/MinVIS_SwinL.yaml \
#   OUTPUT_DIR /mnt/data2/jupiter/li.yu/exps/driveable_terrain_model/ytvis2022_m2f_swl_ft_0503
...
#   --resume MODEL.WEIGHTS /mnt/data2/jupiter/li.yu/exps/driveable_terrain_model/ytvis2022_m2f_swl_ft_0503/model_final.pth \
#   OUTPUT_DIR /mnt/data2/jupiter/li.yu/exps/driveable_terrain_model/ytvis2022_dvis_swl_0503

# Finetune RF-DETR on YTVIS 2022
cd /home/li.yu/code/mymnt/DVIS
python train_rfdetr_ytvis2022.py --epochs 20 --batch-size 4 --devices 4

# # train RF-DETR based DVIS online
# python train_net_video.py \
#   --num-gpus 4 \
